...
excerpt: Czasami używanie atrybutów HTML może być trudniejsze niż się wydaje. Przyjrzyjmy się atrybutowi disabled i aria-disabled w kontekście dostępności i użyteczności.
