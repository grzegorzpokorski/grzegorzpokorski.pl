...
Warto wspomnieć, [że atrybut `placeholder` nie może zastąpić znacznika `label`](https://html.spec.whatwg.org/multipage/input.html#the-placeholder-attribute). O to kilka powodów dlaczego:
