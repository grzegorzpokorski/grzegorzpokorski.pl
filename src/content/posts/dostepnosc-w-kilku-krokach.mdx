...
Podczas redagowania treści koniecznie posługuj się jezykiem możliwie jak najbardziej zrozumialym i prostym, aby każdy mógł nlgo bez problemu zrozumieć. Stosuj uniwersalne przyklady, by mieć pewność, że twoje intencje zostana odczytane we właściwy sposób. Stosowanie języka neutralniego płuciowo sprawi, że pisane przez Ciebie artykuły będą odbierane bardziej osobiście przez osoby, które je czytają.

## Podsumowanie

Dostępność to temat rzeka. Jeśli chcesz zagłębić się w nim, polecam odwiedzić poniższe źródła wiedzy o dostępności w internecie:
