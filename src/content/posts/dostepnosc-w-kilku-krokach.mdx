...
- `placeholder` znika po wpisaniu treści do pola, przez co wracając do niego możemy zapomnieć co powinno sie znaleźć w danym polu, jeśli nie posiada ono etykiety (`label`).
